        ...
        <>
            ...
            <code className="bg-card p-4 rounded mb-6 block">
                <pre className="data-rehype-pretty-code-pre">
                    <span className="text-ring"># Version recommandée : 18.x ou 20.x</span><br />
                    node --version <span className="text-ring"># v18.17.0 ou plus récent</span><br />
                    npm --version  <span className="text-ring"># 9.x ou plus récent</span>
                </pre>
            </code>
            ...
            <p className="mb-8">Alternatives acceptées : <span className="text-chart-5/60 bg-card p-1 rounded-xs">npm</span> ou <span className="text-chart-5/60 bg-card p-1 rounded-xs">yarn</span></p>
            ...
            <code className="bg-card p-4 rounded mb-6 block">
                <pre className="data-rehype-pretty-code-pre">
                    npx create-next-app@latest test-setup --typescript --tailwind --eslint --app<br />
                    cd test-setup<br />
                    npm run dev
                </pre>
            </code>
            <p className="mb-6">Si vous voyez la page Next.js par défaut sur <span className="text-chart-5/60 bg-card p-1 rounded-xs">http://localhost:3000</span>, votre environnement est prêt !</p>
